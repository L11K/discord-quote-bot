...
11. Rename your config.json.example file to config.json and add your Discord bot token inside the quotes `"token":""` *Please note that if you can't see the file extension `.json.example`, make sure you toggle the option to see extensions in your Windows folder settings!*
